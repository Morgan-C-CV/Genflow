...
class RuntimeServiceTest(unittest.TestCase):
    ...
    def test_runtime_service_commit_execute_verify_and_should_continue(self):
        ...
        self.assertTrue(
            session.workflow_metadata["execution_source_evidence"]["backend_echoed_graph_commit_payload_supplied"],
        )
        self.assertTrue(
            session.workflow_metadata["execution_source_evidence"]["backend_echoed_graph_commit_payload_consumed"],
        )
        self.assertTrue(
            session.workflow_metadata["execution_source_evidence"]["backend_echoed_graph_native_execution_realized"],
        )
        self.assertEqual(
